...
void OSCI_channel_init(Osci_ChannelStateMachine*, TIM_TypeDef*, DMA_TypeDef*, uint32_t, ADC_TypeDef*, uint32_t, Measurement_complete_callback, Awd_threshold_callback, Osci_Transceiver* );
