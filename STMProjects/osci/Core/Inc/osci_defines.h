...
#define OSCI_SETTINGS_TRIGGER_COMMAND_ONLY_TRANSFORM 0
#define OSCI_SETTINGS_TRIGGER_COMMAND_MEASURE_SINGLE_X 1
#define OSCI_SETTINGS_TRIGGER_COMMAND_MEASURE_SINGLE_Y 2
#define OSCI_SETTINGS_TRIGGER_COMMAND_MEASURE_CONTINUOUS_X 4
#define OSCI_SETTINGS_TRIGGER_COMMAND_MEASURE_CONTINUOUS_Y 8
#define OSCI_SETTINGS_TRIGGER_COMMAND_MEASURE_STOP 16
